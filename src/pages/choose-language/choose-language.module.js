...
var ChooseLanguageModule = /** @class */ (function () {
    function ChooseLanguageModule() {
    }
    ChooseLanguageModule = __decorate([
        NgModule({
            declarations: [
                ChooseLanguagePage,
            ],
    ...
    return ChooseLanguageModule;
}());
export { ChooseLanguageModule };
